...
use Modules\CMS\App\Http\Controllers\VoteItemController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::prefix('admin')->name('cms.')->group(function () {
    ...
    Route::middleware('cms')->group(function () {
        ...
        Route::resource('vote-items', VoteItemController::class);
        Route::get('/votes', [\App\Http\Controllers\Cms\VotesCmsController::class, 'index'])->name('cms.votes.index');
